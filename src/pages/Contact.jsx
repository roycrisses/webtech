      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Social Media */}
            <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-2xl border border-white/10 p-8">
              <h2 className="text-2xl font-bold mb-4">Follow Us</h2>
              <p className="text-gray-300 mb-6">Stay connected on social media</p>
              <div className="flex gap-4">
                <button className="w-12 h-12 rounded-lg bg-white/10 hover:bg-white/20 transition-colors flex items-center justify-center">
